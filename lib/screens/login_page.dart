...
ScaffoldMessenger.of(context).showSnackBar(
  SnackBar(
    content: Text(l10n.loginEmailOrPhoneRequired),
  ),
);
return;
}
...
Navigator.of(context).pushAndRemoveUntil(
  ...
  setState(() {
    emailError = true;
    emailErrorText =
        e.message ?? l10n.phoneVerificationServiceUnavailable;
  });
  ...
  setState(() {
    ...
    switch (e.code) {
      ...
      case "invalid-email":
        emailError = true;
        emailErrorText =
            emailErrorText = l10n.invalidEmailAddress;
        break;
...
Future<void> resetPassword() async {
  ...
  if (response.statusCode != 200) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(l10n.codeCouldNotBeSent),
      ),
    );
    return;
  }
  ...
  Align(
    ...
    child: PopupMenuButton<String>(
      ...
      onSelected: (value) async {
        ...
        await context.read<LanguageProvider>().changeLanguage(value);
...
controller: emailController,
  ...
  readOnly: widget.isSwitchAccount,
...
decoration: InputDecoration(
  errorText:
  passwordError ? passwordErrorText : null,
